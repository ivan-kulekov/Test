...
public class ExceptionsMessageManagerDemo {
  public static void main(String[] args) {
    ...
    messageManager.registerErrorMessage("1", "3", exceptions);

    System.out.println(messageManager.registerErrorMessage("error4", "Invalid number", exceptions));
    System.out.println(messageManager.raiseError("error2", exceptions));
    System.out.println(messageManager.getErrorMessages(exceptions));
